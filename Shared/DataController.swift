...
class DataController: ObservableObject {
    ...
    func createSampleData() {
        ...
        let notes: [String] = [
            """
            Hello, world!
            Hello, user! Welcome to Commentarium! This is the first note created. Feel free to explore the other notes and around the app.
            """,
            """
            Write down your ideas!
            Commentarium is the best way to capture your thoughts, store your notes, and sync them across the devices.
            """,
            """
            Journal
